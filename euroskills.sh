...
sudo DEBIAN_FRONTEND=noninteractive apt -y install resolvconf dnsutils net-tools tcpdump vsftpd apache2* 
sudo echo "http://www.euroskills.com/" > /var/www/html/index.html
sudo mkdir /var/www/htmls
sudo echo "https://www.euroskills.com/" > /var/www/htmls/index.html
sudo a2enmod ssl 

sudo -u root -s sh -c 'echo "prepend domain-name-servers 172.17.0.2;"  >>  /etc/dhcp/dhclient.conf'
